...
username='AlvaroLlungarriu'
token='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'
repo='githubToken'
...
def downloadFile(filename):
	...
	url=url.replace('AlvaroLlungarriu', username).replace('githubToken', repo).replace('bot.py', filename)
